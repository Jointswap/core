...
UNISWAP_ROUTER.set("56", "0x10ED43C718714eb63d5aA57B78B54704E256024E")  // Pancake
UNISWAP_ROUTER.set("97", "0x10ED43C718714eb63d5aA57B78B54704E256024E")  //not the real one
...
module.exports = async function ({ getNamedAccounts, getChainId, deployments }) {
  ...
  if (UNISWAP_ROUTER.has(chainId)) {
    // If uniswap router is defined above, we will deploy sushiroll
